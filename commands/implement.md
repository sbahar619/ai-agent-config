...
**Output format: no preamble, summary wrap-up, or filler unless asked. Omit empty sections.**
...
- Changed files match the spec; validation run and reported
- Output matches the Done template — no extra sections
